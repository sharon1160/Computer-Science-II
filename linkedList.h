...
{
    Type info;//dato
    nodeType<Type> *link;//puntero link a un nodetype
};
...
class linkedListIterator
{
    public:
        ...
        // Condición posterior: devuelve la información contenida en el nodo.
        linkedListIterator<Type> operator++();
        // Sobrecargar el operador de preincremento.
        // Postcondición: el iterador avanza al siguiente nodo.
        bool operator==(const linkedListIterator<Type>& right) const;
        // Sobrecarga el operador de igualdad.
        // Postcondición: Devuelve verdadero si este iterador es igual a
        // el iterador especificado por la derecha, de lo contrario, devuelve
        // falso.
        bool operator!=(const linkedListIterator<Type>& right) const;
        // Sobrecarga el operador no igual a.
        // Postcondición: Devuelve verdadero si este iterador no es igual a
        // el iterador especificado por la derecha, de lo contrario, devuelve
        // falso.
    private:
        nodeType<Type> *current; //puntero para apuntar al current
        //nodo en la lista enlazada
};
template <class Type>
